 ...
 */
class BirthDateActivity : AppCompatActivity(), HomeFragment.Callbacks,
    BirthdayDetailFragment.Callbacks {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val currentFragment =
            supportFragmentManager.findFragmentById(R.id.birth_date_fragment_container)
        ...
        if (currentFragment == null) {
            ...
            // load the home page normally
                ...
                supportFragmentManager
                    .beginTransaction()
                    .add(R.id.birth_date_fragment_container, fragment)
                    .commit()
            }
        }
